...
class Autoload extends \CodeIgniter\Config\AutoloadConfig
{
	...
	public function __construct()
	{
		...
		$psr4 = [
			...
			'Modules\InventoryManagement'  => ROOTPATH.'modules/InventoryManagement',
			'Modules\ActivityLog'  => ROOTPATH.'modules/ActivityLog',
			'Modules\ItemList'  => ROOTPATH.'modules/ItemList'
		];
