...
class Migrate extends \CodeIgniter\Controller
{
    ...
    public function seeder()
    {
        ...
        // $seeder->call('PermissionBorrowerManagementSeeder');
        // $seeder->call('PermissionInventoryManagementSeeder');
        // $seeder->call('PermissionActivityLogSeeder');
        // $seeder->call('PermissionItemListSeeder');
    }
}
